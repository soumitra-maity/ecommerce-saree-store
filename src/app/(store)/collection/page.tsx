...
// 🔍 Helper to serialize MongoDB documents for React
const serialize = (docs: any[]) => JSON.parse(JSON.stringify(docs));

// ============================================================================
// Server Component: Product Grid (Fetches data)
// ============================================================================
...
// ============================================================================
// Loading Skeleton Component (Shows while data fetches)
// ============================================================================
...
// ============================================================================
// Main Page Component (Exports default)
// ============================================================================
    ...
    <main className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row gap-8">
      ...
      <aside className="w-full md:w-64 shrink-0">
        <div className="bg-white p-5 rounded-xl border border-gray-200 space-y-6 sticky top-24">
          ...
          {/* Category Filter (Strictly mapped to constants.ts) */}
